...
class TestIntersectingGeometries:
    ...
    def test_point_geometry(self):
        ...
        try:
            ...
            regions = pc.get_intersecting_geometries(
                dataset="CA21", level="CT", geometry=point, simplified=False, quiet=True
            )
    ...
    def test_point_geometry_simplified(self):
        ...
        try:
            ...
            regions = pc.get_intersecting_geometries(
                dataset="CA21", level="CT", geometry=point, simplified=True, quiet=True
            )
    ...
    def test_polygon_geometry(self):
        ...
        try:
            ...
            regions = pc.get_intersecting_geometries(
                dataset="CA21", level="CT", geometry=bbox, simplified=False, quiet=True
            )
    ...
    def test_geodataframe_input(self):
        ...
        try:
            ...
            gdf = gpd.GeoDataFrame(
                {"id": [1]}, geometry=[Point(-123.25149, 49.27026)], crs="EPSG:4326"
            )

            regions = pc.get_intersecting_geometries(
                dataset="CA21", level="CT", geometry=gdf, simplified=True, quiet=True
            )
    ...
    def test_geoseries_input(self):
        ...
        try:
            ...
            regions = pc.get_intersecting_geometries(
                dataset="CA21", level="CT", geometry=gs, simplified=True, quiet=True
            )
    ...
    def test_integration_with_get_census(self):
        ...
        try:
            ...
            print(
                f"✅ Integration test: retrieved {len(census_data)} regions with census data"
            )
    ...
    def test_invalid_geometry(self):
        ...
        with pytest.raises(ValueError, match="geometry parameter must be"):
            pc.get_intersecting_geometries(
                dataset="CA21", level="CT", geometry="invalid", quiet=True
            )
