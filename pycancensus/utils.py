...
def validate_level(level: str) -> str:
    ...
    """
    valid_levels = [
        "Regions", "PR", "CMA", "CD", "CSD", "CT", "DA", "EA", "DB"
    ]
...
def process_regions(regions: Dict[str, Union[str, List[str]]]) -> Dict[str, Union[str, List[str]]]:
    """
...
def format_vector_labels(vectors_data: List[Dict], labels: str = "detailed") -> Dict[str, str]:
    """
